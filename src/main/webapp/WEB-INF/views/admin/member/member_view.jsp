...
<c:out value="${memberVO.user_id}"/>
            ...
            <div class="card-footer text-right">
              ...
              <button thpe="button" class="btn btn-default" id ="btn_list">목록</button>
              <!-- 목록으로 이동하려면 pageVO도 가져야함, 또한 삭제/수정은 보안 때문에 
              URL쿼리 스트링으로 보내면 안됨, POST방식으로 보내야함-->
              <input type="hidden" name="page" value="${pageVO.page} ">
              <input type="hidden" name="name_search_type" value="${pageVO.serach_type}">
              <input type="hidden" name="name_search_keyword" value="${pageVO.serch_keyword}">
              <input type="hidden" name="name_search_type" value="${member.user_id}">
