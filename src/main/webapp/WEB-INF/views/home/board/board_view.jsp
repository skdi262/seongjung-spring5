...
<div id="container">
    ...
    <div class="bodytext_area box_inner">			
        ...
        <p class="btn_line txt_right">
            <a href="/home/board/board_list?page=${pageVO.page}&search_type=${pageVO.search_type}" class="btn btn=defalt">목록</a>
